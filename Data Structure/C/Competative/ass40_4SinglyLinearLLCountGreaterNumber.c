...
Algorithm:
    START
        ...
        Count all elements greater than the given number.
        Return the count.
    STOP
*/
...
int main()
{
    ...
    printf("Count of elements which is greater than %d is : %d",iValue,iRet);
...
//          Count of elements which is greater than 35 is : 2
//
/////////////////////////////////////////////////////////////////////////////////
