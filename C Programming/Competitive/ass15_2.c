...
Algorithm:
    ...
    START
        ...
        Perform to return index of first occurence of another number
        Display the result
    STOP
*/
...
// Input    :           int, int, int
// Output   :           int
// Description  :       Perform to return index of first occurence of another number
// Date :               06/06/2026 
...
////////////////////////////////////////////////////////////////////////////////////////////////
//
// Application to perform to return index of first occurence of another number of 3 int values
//
////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    iRet = FirstOcc(Brr, iLength, iValue);                      //display result
...
//Output:   First occurence of number is 1
//
//Input:    N:  6
//          NO: 12
