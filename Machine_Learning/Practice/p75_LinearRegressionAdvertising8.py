...
def MarvellousRegression(Datapath):
    ...
    MSE = mean_squared_error(Y_test, y_Pred)    #Mean Squared Error - It calculates how far the predictions are from the actual values.
    RMSE = np.sqrt(MSE)     #Root Mean Squared Error - tells you approximately how much your prediction differs from the actual Sales value, in Sales units.

    R2 = r2_score(Y_test, y_Pred)   #tells you how well your model explains the variation in the target variable.
