...
class StudyTracker
{
    ...
    public void InsertLog()
    {
        ...
        System.out.println("You are entering the date as : "+lObj);
    ...
    public void SummaryBySubject()
    {
        ...
        //Display the details as per subject : total study hrs
        for(String str : tObj.keySet())
        {
            System.out.println("Subject : " +str+ " Total study duration is : "+tObj.get(str));
        }
